...
public class FXMLReclamationController implements Initializable {
    ...
    ArrayList<Reclamations> mesReclamations ;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ReclamationsService service= new ReclamationsService();
    ...
    private void envoyerReclamation(ActionEvent event) throws MessagingException {
        try {
            ...
            if((titre.getValue() == null))
            {
                ...
                if(msg.validate())
                {
                    if(service.insererReclamation(new Reclamations(1, titre.getValue(), msg.getText(), t)))
                    {
                        Notifications.create()
...
//              }
    ...
    public List<Reclamations> getReclamationsPage(int index) {
        int start = 3 * index;
        int fin = start + 3;
    ...
    private void initReclamationPage(int index) {
        ...
        List<Reclamations> TroisReclamations = getReclamationsPage(index);  
        ReclamationsService serv = new ReclamationsService();
...
//    }
   ...
   private void initialiserDetails(Reclamations get) {
